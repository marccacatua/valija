    ...
    <div className={styles.screen}>
      ...
      {atFreeLimit ? (
        ...
        <div className={styles.body}>
          ...
          <div>
            <SectionLabel hint={t('elegí uno o varios')}>{t('Clima')}</SectionLabel>
          ...
          {form.motivo !== 'trabajo' && (
            <div>
              <SectionLabel hint={t('elegí uno o varios')}>{t('Tipo de turismo')}</SectionLabel>
              <div className={styles.wrap}>
              ...
              {(hasSki || hasBuceo) && (
                <>
                  ...
                  <div className={styles.equipoHint}>
                    {hasSki && hasBuceo
                      ? form.equipoPropio
                        ? t('Sumamos esquís, botas y casco, y traje, chaleco, regulador y aletas. El tubo y el lastre se alquilan siempre.')
                        : t('Asumimos que alquilás allá el equipo de esquí y el de buceo.')
                      : hasSki
                        ? form.equipoPropio
          ...
          <div>
            <SectionLabel hint={t('elegí uno o varios')}>{t('Transporte')}</SectionLabel>
            <div className={styles.wrap}>
          ...
          <div>
            ...
            {lavaRopaAuto && form.lavaRopa && (
              <div className={styles.autoNotice}>
                <span>
                  {t('Como son {n} días o más, marcamos "Pienso lavar ropa en el viaje": la lista calcula la ropa para lavar en el camino.', {
                    n: LAVA_ROPA_AUTO_DIAS,
                  })}
                </span>
